...
This section has two parts, covering different account types. If either part has no flagged accounts, write "No alerts this period" under it.
...
After both parts: 2-3 bullets noting rep or region concentration.
